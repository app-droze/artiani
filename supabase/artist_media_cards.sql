...
--   (title, type, url, thumbnail_path, published_at, excerpt, lang, sort_order, external_source, open_mode, is_published)
-- values
--   (
--     'Studio talk: textiles from paintings',
--     'youtube_video',
--     'https://www.youtube.com/watch?v=VIDEO_ID',
--     'thumbs/en/youtube/2026-02/studio-talk.webp',
--     '2026-02-10T00:00:00Z',
--     'Short intro to translating painting motifs into fabric.',
--     'en',
--     10,
--     'youtube',
--     'modal',
