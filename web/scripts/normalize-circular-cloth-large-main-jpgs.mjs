...
const LOG_PREFIX = "[normalize-circular-cloth-jpgs]";

const CIRCULAR_JPG_TARGETS = [
  {
    target: "cloth-circular-antique_bordeaux-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-antique-bordeaux-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-forest_green-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-forest-green-large-main.jpg",
      "cloth-circular-forest-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-golden-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-golden-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-h_orange-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-horange-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-lilac-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-lilac-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-navy-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-navy-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-antique_olive-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-antique-olive-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-purple-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-purple-large-main.jpg",
    ],
  },
  {
    target: "cloth-circular-sky-large-main.jpg",
    sourceCandidates: [
      "cloth-circular-sky-large-main.jpg",
    ],
  },
];

const CIRCULAR_PNG_TARGETS = [
  "cloth-circular-antique_bordeaux-large-main.png",
  "cloth-circular-forest_green-large-main.png",
  "cloth-circular-golden-large-main.png",
  "cloth-circular-h_orange-large-main.png",
  "cloth-circular-lilac-large-main.png",
  "cloth-circular-navy-large-main.png",
  "cloth-circular-antique_olive-large-main.png",
  "cloth-circular-purple-large-main.png",
  "cloth-circular-sky-large-main.png",
];
...
const main = async () => {
  ...
  for (const asset of CIRCULAR_JPG_TARGETS) {
  ...
  const missingCanonicalJpgs = CIRCULAR_JPG_TARGETS
  ...
  if (missingCanonicalJpgs.length > 0) {
    ...
    for (const pngPath of CIRCULAR_PNG_TARGETS) {
